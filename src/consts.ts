...
export const SITE_TITLE = {
  en: "ta.permanence - (student) activist archives",
  fr: "ta.permanence - archives militantes (étudiantes)",
} as const;
...
export const SOCIALS_MEDIA = {
  ig: "https://www.instagram.com/rdm_luttes_etudiantes",
  fb: "https://www.facebook.com/razdemareeluttesetudiantes",
} as const;

// Routes pour les archives
export const ROUTES_ARCHIVES_CUTE = {
  fr: '/fr/archives/cute',
  en: '/en/archives/swuc',
}
